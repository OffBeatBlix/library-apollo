<template>
  ...
  >
    ...
    <el-row :gutter="20">
      <el-col style="margin-bottom: -0.41px;" :lg="12" :md="16" :sm="24">
        <el-form-item :label="fields.dueDateRange.label" :prop="fields.dueDateRange.name" v-if="!currentUserIsMember">
          <el-date-picker type="datetimerange" v-model="model[fields.dueDateRange.name]"></el-date-picker>
        </el-form-item>
      </el-col>

      <el-col style="margin-bottom: -0.41px;" :lg="12" :md="16" :sm="24">
        <el-form-item :label="fields.returnDateRange.label" :prop="fields.returnDateRange.name" v-if="!currentUserIsMember">
