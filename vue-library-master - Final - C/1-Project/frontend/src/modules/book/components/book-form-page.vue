  ...
  <div>
    ...
    <div class="app-content-page">
      ...
      >
        ...
        <el-form-item :label="fields.id.label" :prop="fields.id.name" v-if="!isCurrentUserIsMember">
        ...
        <el-form-item
          ...
          :required="fields.callNumber.required"
        >
          <el-col :lg="11" :md="16" :sm="24">
            <el-input v-model="model[fields.callNumber.name]" ref="focus" />
          </el-col>
        </el-form-item>
        ...
        <el-form-item
          ...
          :required="fields.edition.required"
        >
          <el-col :lg="11" :md="16" :sm="24">
        ...
        <el-form-item
          ...
          :required="fields.publisher.required"
        >
          <el-col :lg="11" :md="16" :sm="24">
        ...
        <el-form-item
          ...
          :required="fields.copyright.required"
        >
          <el-col :lg="11" :md="16" :sm="24">
        ...
        <el-form-item
          ...
          :required="fields.accession_number.required"
        >
          <el-col :lg="11" :md="16" :sm="24">
        ...
        <el-form-item
          ...
          :required="fields.circulationType.required"
          v-if="!isCurrentUserIsMember"
        >
          <el-col :lg="11" :md="16" :sm="24">
