const en = {
  ...
  entities: {
    loan: {
      ...
      emailAll: {
        label: 'Send Reminders via Email',
    ...
    book: {
      ...
      enumerators: {
        ...
        'circulationType': {
          'circulationCollection': 'Circulation Colletion',
  ...
  home: {
    menu: 'Home',
   /* message: `This page uses fake data for demonstration purposes only. You can edit it at frontend/src/modules/home/components/home-page.vue. Work in Progress.`,
    charts: {
      day: 'Day',
      red: 'Red',
      green: 'Green',
